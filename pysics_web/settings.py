...
# Postgress
DATABASES = {
    'default':dj_database_url.parse('postgresql://yt_pysics_user:9aZQMjaxpu2HNxBdkbO6kXiy8VooT1nT@dpg-d31frc3ipnbc73bdrb90-a.oregon-postgres.render.com/yt_pysics')
}
